...
import {
  booking_schedules,
  booking_schedules as bookingDetail,
} from '@prisma/client';
...
import {
  DRAFT,
  PROCESSING,
  READY_FOR_ID_CARD_PRINTING,
  ID_CARD_READY_FOR_COLLECTION,
  RESUBMISSION,
  RESUBMITTED,
  COMPLETED,
    ...
    >
      ...
      <div className={dashBoardContentstyles.mainContainer}>
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle className={globalStyleCss.header2}>
            Information
          </DialogTitle>
          <DialogContent>
            <div className={globalStyleCss.regular}>
              Please note that the ID Card expiry date will remain the same.
            </div>
          </DialogContent>
          <DialogActions>
        ...
        <div className={dashBoardContentstyles.container}>
          <div className={globalStyleCss.regularBoldWhite}>Welcome</div>
          <div className={globalStyleCss.header1White}>{users?.name}</div>
        </div>
        ...
        <div className={dashBoardContentstyles.centerBox}>
          <div className={dashBoardContentstyles.myApplication}>
              ...
              <table>
                <thead>
                  <tr className={globalStyleCss.regularBold}>
                    <th className={dashBoardContentstyles.item2}>
                      Application Type
                    </th>
                    <th className={dashBoardContentstyles.item}>
                      License Type
                    </th>
                    <th className={dashBoardContentstyles.item1}>Grade</th>
                    <th className={dashBoardContentstyles.item3}>
                      Expiry Date
                    </th>
                    <th className={dashBoardContentstyles.item3}>
                      Application Status
                ...
                <tbody>
                  {bookingSchedules.map((booking) => (
                    <>
                      ...
                      >
                        <td className={dashBoardContentstyles.item2}>
                          {booking.app_type == '1' ? 'New' : 'Existing'}
                        </td>
                        <td
                          className={dashBoardContentstyles.item}
                          style={{ whiteSpace: 'pre-line' }}
                        >
                          {cardTypeMap[booking.card_id || ''] || 'Unknown'}
                        </td>
                        <td className={dashBoardContentstyles.item1}>
                          {gradeTypeMap[booking.grade_id || ''] || ''}
                        </td>
                        <td className={dashBoardContentstyles.item3}>
                          {formatDate(
                            booking.expired_date ? booking.expired_date : ''
                          ) || ''}
                        </td>
                        ...
                        <td className={dashBoardContentstyles.item3}>
                          ...
                          {booking.app_type == '2' &&
                          (booking.Status_app == '' || !booking.Status_app) ? (
                            <>Issued</>
                          ) : null}
                        ...
                        booking.appointment_date && (
                          ...
                          >
                            <td colSpan={6}>
                              <div
                                className={
                                  dashBoardContentstyles.collectionHeader
                                }
                              >
                                <svg
                                ...
                                &nbsp;You have made an appointment to collect
                                your new ID Card on{' '}
                                {formatDate(
                                  booking.appointment_date
                                    ? booking.appointment_date
                                ...
                                , {booking.time_start_appointment} -{' '}
                                {booking.time_end_appointment}
                              </div>
                            </td>
                          </tr>
                        )}
            ...
            {bookingSchedules.map((booking) => (
              <div
                key={`bs-${booking.id}`}
                className={dashBoardContentstyles.recordContainerMobile}
              >
                ...
                <div className={dashBoardContentstyles.item}>
                  <div className={dashBoardContentstyles.cell}>
                    <div className={globalStyleCss.regularBold}>Action</div>
                  </div>
                  <div className={dashBoardContentstyles.cell}>
                    <div className={globalStyleCss.regular}>
                      {booking.app_type == '2' &&
