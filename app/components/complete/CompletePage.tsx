  ...
  return (
    <form>
      ...
      <div className={CompleteContentstyles.container}>
        {reschedule && (
          <>
            <div className={globalStyleCss.header1}>Reschedule Appointment</div>
          </>
        )}

        {!reschedule && (
          <>
            <div className={globalStyleCss.header1}>Book Appointment</div>
          </>
        )}
          ...
          <div className={CompleteContentstyles.innerContainerBox}>
            ...
            <div className={CompleteContentstyles.smsTextContainer}>
              <div className={globalStyleCss.regular}>
                An SMS reminder will be sent to you 3 days before the collection
                date.
              </div>
            </div>
        ...
        <div className={CompleteContentstyles.buttonContainer}>
          <button
            className={CompleteContentstyles.saveDraft}
            type='button'
          ...
          <button
            className={CompleteContentstyles.continue}
            type='button'
            onClick={onComplete}
          >
