        ...
        <div className={styleBarModule.pageHeading}>
          {formData.applicationType == '1' && formData.cardId == '1' ? (
            <>
              ...
              <div className={globalStyleCss.header2}>
                Security Officer (SO) / Aviation Security Officer (AVSO)
              </div>
            </>
          ) : (
            <> </>
          ...
          {formData.applicationType == '1' && formData.cardId == '3' ? (
            <>
              <div className={globalStyleCss.header2}>
                Application for New ID Card: Private investigator (PI)
              </div>
            </>
          ) : (
            <> </>
          ...
          {formData.applicationType == '2' && formData.cardId == '3' ? (
            <>
              <div className={globalStyleCss.header2}>
                Replacement ID Card: Private investigator (PI)
              </div>
            </>
          ) : (
            <> </>
          ...
          {formData.applicationType == '3' && formData.cardId == '3' ? (
            <>
              <div className={globalStyleCss.header2}>
                Renew ID Card: Private investigator (PI)
              </div>
            </>
          ) : (
            <> </>
        ...
        <div className={styleBarModule.menuBar}>
          <ul className={styleBarModule.stepList}>
            {steps.map((step, index) => {
              ...
              if (index === activeStep) {
                return (
                  ...
                  >
                    ...
                    <div className={styleBarModule.stepText}>
                      <h1>{text}</h1>
                    </div>
                    {index < steps.length - 1 && (
                      <div className={styleBarModule.connectorLine}></div>
                    )}
                  </li>
                );
              }
              ...
              if (index > activeStep) {
                return (
                  <li key={index} className={`${styleBarModule.stepItem}`}>
                    <div className={styleBarModule.stepNumber}>{number}</div>
                    <div className={styleBarModule.stepText}>
                      <h1>{text}</h1>
                    </div>
