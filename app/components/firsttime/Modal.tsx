      ...
      <div className={styleCss.modelContainer}>
        <div className={styleCss.modelBox}>
          ...
          <div className={globalStyleCss.regular}>
            For successful application, it may take  48 -72 hours for your approved data from the Police Regulatory Department to be updated on USE&apos;s ID card portal. Please try again later.
          </div>
